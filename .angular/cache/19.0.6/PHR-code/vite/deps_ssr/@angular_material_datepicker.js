...
var MatFormField = class _MatFormField {
  ...
  _initializeControl(previousControl) {
    ...
    this._describedByChanges?.unsubscribe();
    this._describedByChanges = control.stateChanges.pipe((0, import_operators4.startWith)([void 0, void 0]), (0, import_operators4.map)(() => [control.errorState, control.userAriaDescribedBy]), (0, import_operators4.pairwise)(), (0, import_operators4.filter)(([[prevErrorState, prevDescribedBy], [currentErrorState, currentDescribedBy]]) => {
      return prevErrorState !== currentErrorState || prevDescribedBy !== currentDescribedBy;
    })).subscribe(() => this._syncDescribedByIds());
    this._valueChanges?.unsubscribe();
    if (control.ngControl && control.ngControl.valueChanges) {
      this._valueChanges = control.ngControl.valueChanges.pipe((0, import_operators4.takeUntil)(this._destroyed)).subscribe(() => this._changeDetectorRef.markForCheck());
    }
  }
...
var AutofillMonitor = class _AutofillMonitor {
  ...
  monitor(elementOrRef) {
    ...
    const result = new import_rxjs6.Subject();
...
var CdkTextareaAutosize = class _CdkTextareaAutosize {
  ...
  _ngZone = inject(NgZone);
  _renderer = inject(Renderer2);
  _resizeEvents = new import_rxjs6.Subject();
  ...
  ngAfterViewInit() {
    if (this._platform.isBrowser) {
      ...
      this._ngZone.runOutsideAngular(() => {
        ...
        this._resizeEvents.pipe((0, import_operators5.auditTime)(16)).subscribe(() => {
...
var MatDatepickerIntl = class _MatDatepickerIntl {
   ...
   */
  changes = new import_rxjs8.Subject();
...
var MatDateSelectionModel = class _MatDateSelectionModel {
  selection;
  _adapter;
  _selectionChanged = new import_rxjs8.Subject();
...
var MatMonthView = class _MatMonthView {
  ...
  _rerenderSubscription = import_rxjs8.Subscription.EMPTY;
...
var MatCalendar = class _MatCalendar {
   ...
   */
  stateChanges = new import_rxjs8.Subject();
  constructor() {
    if (typeof ngDevMode === "undefined" || ngDevMode) {
      if (!this._dateAdapter) {
        throw createMissingDateImplError("DateAdapter");
...
var MatDatepickerContent = class _MatDatepickerContent {
  ...
  _subscriptions = new import_rxjs8.Subscription();
  _model;
  ...
  _animationDone = new import_rxjs8.Subject();
...
var MatDatepickerBase = class _MatDatepickerBase {
  ...
  _inputStateChanges = import_rxjs8.Subscription.EMPTY;
  _document = inject(DOCUMENT);
  ...
  _getCloseStream(overlayRef) {
    ...
    return (0, import_rxjs8.merge)(overlayRef.backdropClick(), overlayRef.detachments(), overlayRef.keydownEvents().pipe((0, import_operators6.filter)((event) => {
...
var MatDatepickerInputBase = class _MatDatepickerInputBase {
  ...
  _valueChangesSubscription = import_rxjs8.Subscription.EMPTY;
  _localeSubscription = import_rxjs8.Subscription.EMPTY;
  /**
  ...
  _matchesFilter(value) {
    const filter6 = this._getDateFilter();
    return !filter6 || filter6(value);
  }
...
var MatDatepickerInput = class _MatDatepickerInput extends MatDatepickerInputBase {
  ...
  _closedSubscription = import_rxjs8.Subscription.EMPTY;
  _openedSubscription = import_rxjs8.Subscription.EMPTY;
...
var MatDatepickerToggle = class _MatDatepickerToggle {
  _intl = inject(MatDatepickerIntl);
  _changeDetectorRef = inject(ChangeDetectorRef);
  _stateChanges = import_rxjs8.Subscription.EMPTY;
  ...
  _watchStateChanges() {
    const datepickerStateChanged = this.datepicker ? this.datepicker.stateChanges : (0, import_rxjs8.of)();
    const inputStateChanged = this.datepicker && this.datepicker.datepickerInput ? this.datepicker.datepickerInput.stateChanges : (0, import_rxjs8.of)();
    const datepickerToggled = this.datepicker ? (0, import_rxjs8.merge)(this.datepicker.openedStream, this.datepicker.closedStream) : (0, import_rxjs8.of)();
    this._stateChanges.unsubscribe();
    this._stateChanges = (0, import_rxjs8.merge)(this._intl.changes, datepickerStateChanged, inputStateChanged, datepickerToggled).subscribe(() => this._changeDetectorRef.markForCheck());
  }
...
var MatDateRangeInput = class _MatDateRangeInput {
  ...
  ngAfterContentInit() {
    ...
    (0, import_rxjs8.merge)(this._startInput.stateChanges, this._endInput.stateChanges).subscribe(() => {
      this.stateChanges.next(void 0);
    });
  }
  ngOnChanges(changes) {
